 ...
 * @author laptop
 */
@WebServlet(name="searchguest", urlPatterns={"/searchguest"})
public class searchguest extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet searchguest</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet searchguest at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        String name = request.getParameter("nameguest");
        ...
        List<Booking> listBooking = md.getAllBookingByGuestName(name);
