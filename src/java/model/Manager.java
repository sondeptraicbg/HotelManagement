...
public class Manager {
    ...
    public Manager(int EmployeeID, int HotelCode, String FirstName, String LastName, String Gender, String DateOfBirth, String Email, int Salary, String Role, String Password, long Phone, String RoleDesc) {
